...
import com.twakeapps.drivingquizapp.QuizModel
import com.twakeapps.drivingquizapp.R
...
class QuizFragment: Fragment()
{
    ...
    private val quizs = arrayOf(
            QuizModel(
                    ...
                    imageUrl = "",
                    answers = arrayOf("ক। রেডিয়েটরের পানিকে ঠান্ডা করা",
            ...
            QuizModel(
                    id = 1,
                    question = "ইঞ্জিন অতিরিক্ত গরম হওয়ার কারণ কি?",
                    imageUrl = "",
                    answers = arrayOf(
            ...
            QuizModel(
                    id = 2,
                    question = "এই চিহ্নটি দ্বারা কি বুঝায়?",
                    imageUrl = "no_cycle.png",
                    answers = arrayOf(" ক) শুধুমাত্র সাইকেল চলাচলের জন্য",
        ...
        binding.btnNext.setOnClickListener {
            ...
            if(tempQuestionIndex < quizs.count()){
                ...
                val bundle = Bundle().apply {
                    ...
                    putInt("TOTAL_CORRECT", tempCorrectAnsCount)
                }
    ...
    private fun setTheQuestion(qIndex:Int){
        ...
        //inding.tvThum.setImageResource(R.drawable.baseline_info_24)

        if (q.imageUrl.isEmpty()){
            binding.tvThum.visibility = View.GONE
        }else{
            binding.tvThum.visibility = View.VISIBLE
            ...
            try
            {
                ...
                binding.tvThum.setImageDrawable(d)
